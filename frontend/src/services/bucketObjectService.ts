...
import type { BucketObject, SearchBucketObjectsOptions } from '@/types';

const BUCKET_PATH = 'bucket';

export default {
  /**
   * @function searchBucketObjects
   * Returns a list of buckets & objects
   * @param {SearchBucketObjectsOptions} params Optional object containing the data to filter against
   * @returns {Promise} An axios response
   */
  searchBucketObjects(params?: SearchBucketObjectsOptions) {
